...
export const en = defineConfig({
  lang: "en-US",
  description:
    "A modern Vue 3 + TypeScript admin scaffold based on Ant Design Vue",
  ...
  themeConfig: {
    ...
    sidebar: {
      "/en/guide/": [
          ...
          items: [
            {
              ...
              link: "/en/guide/development-workflow",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "ProTable Advanced Scaffold",
              link: "/en/guide/scaffold-pro-table-advanced",
            },
            {
              text: "Complex Form Scaffold",
              link: "/en/guide/scaffold-complex-form",
            },
            {
              text: "Master Detail Scaffold",
              link: "/en/guide/scaffold-master-detail",
            },
            {
              text: "Virtual Table Scaffold",
              link: "/en/guide/scaffold-virtual-table",
            },
          ],
        },
        {
          ...
          items: [
            {
              text: "Upload System Scaffold",
              link: "/en/guide/scaffold-upload-system",
            },
            {
              text: "State Cache Scaffold",
              link: "/en/guide/scaffold-state-cache",
            },
            {
              text: "Import Export Scaffold",
              link: "/en/guide/scaffold-import-export",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              text: "Advanced Filter Scaffold",
              link: "/en/guide/scaffold-advanced-filter",
            },
          ],
        },
        {
          ...
          items: [
            ...
            { text: "Role Management", link: "/en/guide/system-role" },
            {
              ...
              link: "/en/guide/system-permission",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "Request Auth and Token Refresh",
              link: "/en/guide/security-request-auth",
            },
            {
              text: "RBAC Flow in Practice",
              link: "/en/guide/security-rbac-flow",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            {
              text: "Integration Navigation",
              link: "/en/guide/integration-navigation",
            },
      ...
      "/en/components/": [
        {
          ...
          items: [
            ...
            { text: "ProModal", link: "/en/components/pro-modal" },
            {
              ...
              link: "/en/components/pro-descriptions",
            },
            ...
            { text: "ProCodeEditor", link: "/en/components/pro-code-editor" },
          ],
        },
      ],
    },
    ...
    editLink: {
      pattern:
        "https://github.com/yelog/antdv-next-admin-doc/edit/main/docs/:path",
