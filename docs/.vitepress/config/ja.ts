...
export const ja = defineConfig({
  lang: "ja-JP",
  description:
    "Vue 3 + TypeScript + Ant Design Vue に基づくモダンな管理システムスターター",
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: "コンポーネント",
        link: "/ja/components/pro-table",
        activeMatch: "/ja/components/",
      },
      ...
      "/ja/guide/": [
        ...
        },
        {
          ...
          items: [
            {
              text: "開発ワークフロー",
              link: "/ja/guide/development-workflow",
            },
      ...
      "/ja/components/": [
        {
          ...
          items: [
            ...
            { text: "ProModal", link: "/ja/components/pro-modal" },
            {
              ...
              link: "/ja/components/pro-descriptions",
            },
