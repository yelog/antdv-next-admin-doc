...
export const zh = defineConfig({
  lang: "zh-CN",
  description:
    "基于 Vue 3 + TypeScript + Ant Design Vue 的现代化后台管理系统脚手架",
      ...
      "/guide/": [
        ...
        },
        {
          ...
          items: [
            {
              text: "高级表格脚手架",
              link: "/guide/scaffold-pro-table-advanced",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "文件上传系统脚手架",
              link: "/guide/scaffold-upload-system",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "请求鉴权与自动刷新",
              link: "/guide/security-request-auth",
            },
        ...
        },
        {
          ...
          items: [
            {
              text: "集成导航（外链与 IFrame）",
              link: "/guide/integration-navigation",
            },
            {
              text: "异常页体系（403/404/500）",
              link: "/guide/exception-pages",
            },
          ],
        },
        {
      ...
      "/components/": [
        {
          ...
          items: [
            ...
            {
              text: "ProDescriptions 描述列表",
              link: "/components/pro-descriptions",
            },
            ...
            {
              text: "ProSplitLayout 分栏布局",
              link: "/components/pro-split-layout",
            },
            {
              text: "ProCodeEditor 代码编辑器",
              link: "/components/pro-code-editor",
            },
          ],
        },
      ],
